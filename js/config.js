...
// Ingame-Status
'game.pause':'⏸ Pause','friends.none':'No friends yet','friend.wants':'wants to add you as a friend!','friends.none':'Noch keine Freunde','friend.wants':'möchte dich als Freund hinzufügen!','game.resume':'▶ Weiter',
...
'vier.p.turn':'{name} ist dran','game.ready':'Bereit','game.pause':'⏸ Pause','friends.none':'No friends yet','friend.wants':'wants to add you as a friend!','friends.none':'Noch keine Freunde','friend.wants':'möchte dich als Freund hinzufügen!','game.new':'↺ Neu','game.continue':'▶ Weiterspielen','game.restart':'↺ Neustart','game.wait':'Warte...','game.your.turn':'Du bist dran! Klicke auf das rechte Feld!',
...
'vier.p.turn':'{name}\'s turn','game.ready':'Ready','game.pause':'⏸ Pause','friends.none':'No friends yet','friend.wants':'wants to add you as a friend!','friends.none':'Noch keine Freunde','friend.wants':'möchte dich als Freund hinzufügen!','game.new':'↺ New','game.continue':'▶ Continue','game.restart':'↺ Restart','game.wait':'Wait...','game.your.turn':'Your turn! Click the right field!',
...
// Ingame-Status
'game.pause':'⏸ Pause','friends.none':'No friends yet','friend.wants':'wants to add you as a friend!','friends.none':'Noch keine Freunde','friend.wants':'möchte dich als Freund hinzufügen!','game.resume':'▶ Resume',
...
function t(key){return(TRANSLATIONS[currentLang]||TRANSLATIONS.de)[key]||TRANSLATIONS.de[key]||'';}
let friendsList=[];
let socialWs=null;
let unreadCounts={};
